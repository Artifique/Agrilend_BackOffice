...
import { BarChart3, Users, ShoppingCart, DollarSign, Truck, AlertTriangle, Settings, Package, FileText } from 'lucide-react';
      ...
      <div className="flex flex-col items-center justify-center h-32 px-6 border-b border-gray-200 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-2 right-4 w-6 h-6 bg-green-500 rounded-full"></div>
                ...
                {/* Logo principal - Plus grand et visible */}
            ...
            return (
              ...
              >
                <div className={`flex items-center justify-center w-8 h-8 rounded-lg mr-3 transition-all duration-300
                  ${isActive ? 'bg-white/20 text-[#1E90FF] shadow-md' : 'bg-gray-100 text-gray-500 group-hover:bg-[#1E90FF]/10 group-hover:text-[#1E90FF]'}`}>
